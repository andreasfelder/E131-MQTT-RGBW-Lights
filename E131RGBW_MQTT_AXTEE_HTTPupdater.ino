...
#define MQTT_CLIENT_NAME    "name" //This name will be used for all MQTT Messages, must be unique.
...
const char* update_username = "firmware_username";
const char* update_password = "firmware_password";
...
void setup() {
    ...
    httpServer.begin();
    Serial.printf("HTTPUpdateServer ready! Open /firmware in your browser and login with username '%s' and password '%s'\n", update_username, update_password);
